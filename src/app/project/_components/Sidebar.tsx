...
export default function Sidebar({ id }: SidebarProps) {
  ...
  const avatarDataUri = useMemo(() => {
    try {
      ...
      return "data:image/svg+xml;base64,PHN2ZyB4bWxucz0naHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmcnIHdpZHRoPScxJyBoZWlnaHQ9JzEnLz4=";
    }
  }, [id]);
      ...
      >
        <div className="h-full flex flex-col gap-4">
          ...
          <div className="flex-1 overflow-auto space-y-3">
            ...
            <div className="rounded-md p-3 bg-card">
              <h4 className="text-sm font-medium">Quick Actions</h4>
              <div className="mt-2 flex flex-col gap-2">
                <button className="text-sm rounded-md px-3 py-2 bg-primary/10 hover:bg-primary/20">
                  New Task
                </button>
                <button className="text-sm rounded-md px-3 py-2 border">
                  Share
                </button>
              </div>
            </div>
