    ...
    <div className="bg-background relative flex min-h-screen w-full items-start justify-center overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <motion.div
          ...
          className="bg-accent/30 absolute top-20 left-1/2 h-56 w-[85%] max-w-5xl -translate-x-1/2 rounded-xl blur-2xl"
        />
        <motion.div
          animate={{ opacity: [0.05, 0.1, 0.05], y: [0, 10, 0] }}
          transition={{ duration: 16, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="bg-secondary/40 absolute top-64 left-1/2 h-40 w-[75%] max-w-4xl -translate-x-1/2 rounded-xl blur-xl"
        />
        <div className="bg-accent/20 dark:bg-accent/10 to-background absolute inset-x-0 bottom-0 h-40 bg-linear-to-b from-transparent" />
      </div>
      ...
      <div className="absolute top-5 left-5 z-20 flex items-center gap-1.5">
        <div
          className={`h-1.5 w-1.5 rounded-full transition-all duration-300 ${
            currentStep >= 1 ? "bg-primary w-7" : "bg-muted"
          }`}
        />
        <div
          className={`h-1.5 w-1.5 rounded-full transition-all duration-300 ${
            currentStep >= 2 ? "bg-primary w-7" : "bg-muted"
          }`}
        />
      </div>

      <div className="relative z-10 flex w-full max-w-4xl flex-col items-start gap-12 px-5 py-12 md:px-8 lg:px-12">
        <AnimatePresence mode="wait">
          ...
          {currentStep === 1 && (
            ...
            >
              ...
              >
                <div className="border-border/50 bg-card/30 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-sm backdrop-blur-sm">
                  <span>👋</span>
              ...
              >
                ...
                <div className="border-border/50 bg-card/50 group relative w-full overflow-hidden rounded-lg border shadow-md backdrop-blur-sm">
                  <video
                    src="/demo.mp4"
                    controls
                    className="h-full max-h-80 w-full rounded-lg object-cover transition-all group-hover:brightness-105"
              ...
              <motion.section
                ...
                className="border-border/30 flex w-full flex-col gap-6 border-t pt-10"
              >
                ...
                <div className="flex w-full flex-col gap-3">
                  {introSteps.map((step, index) => (
                    <motion.div
                      ...
                      className="group border-border/50 bg-card/30 hover:border-primary/40 hover:bg-card/50 flex w-full flex-col gap-2.5 rounded-lg border p-5 backdrop-blur-sm transition-all"
                    >
              ...
              <motion.footer
                ...
                className="border-border/30 flex w-full flex-col items-start gap-3 border-t pt-10"
              >
                <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex flex-col gap-0.5">
                    <h3 className="text-lg font-semibold">Ready to start building?</h3>
                  ...
                  <motion.button
                    ...
                    className="group bg-primary text-primary-foreground relative overflow-hidden rounded-md px-5 py-2.5 text-sm font-medium shadow-md transition-all hover:shadow-lg"
                  >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <p className="text-muted-foreground flex max-w-xl items-start gap-1.5 text-xs">
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2">
                      {[
                        ...
                        <button
                          ...
                          className={`border-border/50 rounded-lg border p-4 text-left transition-all ${
                  ...
                  >
                    <button
                      ...
                      className="border-primary/40 bg-primary/5 hover:bg-primary/10 group w-full rounded-lg border-2 border-dashed p-5 transition-all disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          <div className="bg-primary/20 text-primary rounded-full p-2.5">
                  ...
                  <div className="relative flex items-center gap-3">
                    ...
                    <span className="text-muted-foreground text-xs">or build your own</span>
                    <div className="border-border/50 flex-1 border-t" />
                  </div>
                  ...
                  >
                    <div>
                      <h2 className="text-base font-semibold">2. Select your core stack</h2>
                      <p className="text-muted-foreground mt-0.5 text-xs">
                    ...
                    <div className="flex flex-col gap-2.5">
                      <h3 className="flex items-center gap-1.5 text-xs font-medium">
                        <span>Lightning</span> Full-Stack
                      </h3>
                      <div className="grid grid-cols-1 gap-2.5 md:grid-cols-3">
                        {fullStackOptions.map((stack) => (
                          <button
                            ...
                            className={`border-border/50 relative rounded-md border p-3.5 text-left transition-all ${
                          ...
                          <div className="grid grid-cols-2 gap-2.5 md:grid-cols-4">
                            {frontendOptions.map((stack) => (
                              <button
                                ...
                                className={`border-border/50 relative rounded-md border p-3 text-left transition-all ${
                                  frontendId === stack.id
                                    ? "border-primary bg-primary/10 ring-primary/20 ring-2"
                                    : "bg-card/30 hover:border-primary/40 hover:bg-card/50"
                                }`}
                  ...
                  <motion.section
                    ...
                    className="border-border/30 flex flex-col gap-3 border-t pt-5"
                  >
                    <div>
                      <h2 className="text-base font-semibold">3. Optional: Pre-select tools</h2>
                      <p className="text-muted-foreground mt-0.5 text-xs">
                          ...
                          {section.options.map((stack) => {
                            ...
                            return (
                              <button
                                ...
                                className={`border-border/50 relative rounded-md border p-2.5 text-left transition-all ${
                                  isSelected
                              ...
                              >
                                <span className="text-xs font-medium">{stack.name}</span>
                                {isSelected && (
                                  <div className="absolute top-1.5 right-1.5 rounded-full bg-purple-500 p-0.5">
                                    <Check className="h-2.5 w-2.5 text-white" />
                                  </div>
                                )}
                              </button>
                  ...
                  {error && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="bg-destructive/10 text-destructive border-destructive/20 rounded-md border p-3 text-xs"
                    >
                      {error}
                    </motion.div>
                  )}
                  ...
                  <motion.footer
                    ...
                    className="border-border/30 flex w-full items-center justify-between gap-3 border-t pt-5"
                  >
                    <button
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <motion.button
                        ...
                        className="group bg-primary text-primary-foreground relative overflow-hidden rounded-md px-5 py-2.5 text-sm font-medium shadow-md transition-all hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
                      >
